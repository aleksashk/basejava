...
public abstract class AbstractStorageTest {
    ...
    static {
        RESUME_1 = new Resume(UUID_1, "Resume1");
        RESUME_2 = new Resume(UUID_2, "Resume2");
        RESUME_3 = new Resume(UUID_3, "Resume3");
        RESUME_4 = new Resume(UUID_4, "Resume4");
    }
    ...
    public void update() throws Exception {
        Resume newResume = new Resume(UUID_1, "Resume1111");
